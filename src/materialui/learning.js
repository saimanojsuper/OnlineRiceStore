        ...
        <div>
          <Container maxWidth="sm" className={classes.container}>
            ...
            <Typography
              ...
              paragraph
            >
              Need to check the long paragraph to trying to write the text as
              much as possible to make it paragraph.If true, the text will not
              wrap, but instead will truncate with a text overflow ellipsis.
            </Typography>
          </Container>
